export default function PurchaseOrderListHeader() {
  return (
    <li className="px-4 py-6 grid items-center gap-4 grid-cols-[1fr_1fr_60px_4fr_1fr_1fr_1fr_40px_16px] text-sm font-semibold border-y">
      <span className="text-center">주문일</span>
      <span className="text-center">주문명</span>
