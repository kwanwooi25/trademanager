...
export default function ProductListItem({ product }: Props) {
  ...
  const getAddPurchaseOrderUrl = (optionId: string) =>
    `${PATHS.ADD_PURCHASE_ORDER}?productOptionId=${optionId}&callbackUrl=${currentUrl}`;
            ...
            <AlertDialog>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href={getAddPurchaseOrderUrl(id)}>
